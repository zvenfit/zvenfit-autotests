...
| Тарифы тренировок | персональные, парные, подростковые и реформер: обе вкладки, пакеты, скидки, пробные занятия, сплит, JSON-LD и размещение подросткового прайса на странице персональных тренировок | product contract + UI + staging |
